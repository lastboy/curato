...
async function fetchGithubConfig(extendsRef) {
...
export async function readTeamConfig(cwd) {
    ...
    const merged = safeMerge(local, remote);
    return merged;
}
export function validateTeamConfig(raw) {
    const errors = [];
    if (!raw || typeof raw !== 'object' || Array.isArray(raw)) {
    ...
    if (obj['marketplaces'] !== undefined) {
        if (typeof obj['marketplaces'] !== 'object' || Array.isArray(obj['marketplaces'])) {
            ...
            for (const [name, entry] of Object.entries(obj['marketplaces'])) {
                ...
                if (e['scope'] !== undefined && !['user', 'project', 'local'].includes(e['scope'])) {
    ...
    if (obj['mcpServers'] !== undefined) {
        if (typeof obj['mcpServers'] !== 'object' || Array.isArray(obj['mcpServers'])) {
            ...
            for (const [name, entry] of Object.entries(obj['mcpServers'])) {
                if (!entry || typeof entry !== 'object') {
                ...
                if (typeof e['command'] !== 'string')
                    errors.push(`mcpServers.${name}: "command" must be a string`);
    ...
    if (obj['plugins'] !== undefined) {
        if (!Array.isArray(obj['plugins'])) {
            ...
            obj['plugins'].forEach((p, i) => {
                if (typeof p === 'string')
                    return; // simple string form — valid
                    ...
                    if (!pe['skills'] || typeof pe['skills'] !== 'object' || Array.isArray(pe['skills'])) {
                        ...
                        for (const key of ['include', 'exclude']) {
                            ...
                            if (!Array.isArray(s[key])) {
                                ...
                                s[key].forEach((v, j) => {
                                    if (typeof v !== 'string')
                                        errors.push(`plugins[${i}].skills.${key}[${j}]: must be a string`);
                                });
                            }
                        }
                    }
    ...
    if (obj['claudeMd'] !== undefined) {
        if (typeof obj['claudeMd'] !== 'object' || Array.isArray(obj['claudeMd'])) {
            ...
            const md = obj['claudeMd'];
            for (const scope of ['project', 'user']) {
                if (md[scope] !== undefined) {
                    const entry = md[scope];

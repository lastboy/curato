...
`;
export async function installAgentGuide(argv) {
    ...
    if (!userScope)
        info('Tip: use --user to install at ~/.claude/CLAUDE.md instead.');
    warn('Reload Claude Code for the new CLAUDE.md to take effect.');
}
//# sourceMappingURL=install-agent-guide.js.map
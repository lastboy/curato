    ...
    try {
        switch (command) {
            ...
            case 'launch-chrome':
                ...
                break;
            case 'install-agent-guide':
                await installAgentGuide(args);
                break;
            case 'install-shell-env':
                await installShellEnvCmd(args);
                break;
            case 'uninstall-shell-env':
                await uninstallShellEnvCmd(args);
                break;
            default:

 ...
 * file at login time.
 */
export function buildPlist(vars: string[], sourceFile: string): string {
...
export function installShellEnv(opts: InstallShellEnvOptions): InstallShellEnvResult {
...
export function uninstallShellEnv(opts: UninstallShellEnvOptions): UninstallShellEnvResult {
  const plistPath = opts.targetPath ?? launchAgentPath();
 ...
 */
export function readInstalledVars(targetPath?: string): string[] {
